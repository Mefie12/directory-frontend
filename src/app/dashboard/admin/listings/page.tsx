...
export default function Listings() {
    ...
    const loadCategories = async () => {
        ...
        try {
            ...
            if (categories.length > 0 && !selectedMainCategory) {
                const firstMainCategory = categories.find(cat =>
                    cat.type === 'mainCategory' || cat.parent_id === null
                );
    ...
    const handleAddCategoryClick = () => {
        ...
        setCategoryFormData({
            ...
            description: '',
            is_main: false,
            parent_id: selectedMainCategory?.id || (mainCategories.length > 0 ? mainCategories[0].id : null),
        });
    ...
    const handleDeleteCategoryClick = async (category: Category) => {
        ...
        try {
            ...
            setAllCategories(prev => prev.filter(item => item.id !== category.id));
    ...
    const handleMainCategoryChange = (checked: boolean) => {
        setCategoryFormData(prev => ({
            ...
            parent_id: checked ? null : (selectedMainCategory?.id || (mainCategories.length > 0 ? mainCategories[0].id : null))
        }));
    };
                    ...
                    <div className="space-y-6 py-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value: 'subCategory' | 'mainCategory' | 'tag') => setCategoryFormData(prev => ({
                                    ...prev,
                                    type: value
                                }))}
                            >
