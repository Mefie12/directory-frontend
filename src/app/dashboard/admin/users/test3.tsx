...
export default function Users() {
  ...
  useEffect(() => {
    ...
    const filteredData = safeAllData.filter((user) => {
      // Data Normalization: vital for robust filtering
      const userRole = (user.role || "").toLowerCase().trim();
      const userStatus = (user.status || "").toLowerCase().trim();
      const currentStatusFilter = statusFilter.toLowerCase().trim();
      ...
      // 2. Status Filter
      if (currentStatusFilter !== "all" && userStatus !== currentStatusFilter) {
        return false;
      }
  ...
  const getRoleBadgeColor = (role: string) => {
    ...
    switch (r) {
      case "vendor": return "bg-orange-500 hover:bg-orange-600";
      case "customer":
  ...
  const getPlanBadgeVariant = (plan: string) => {
    ...
    switch (p) {
      case "basic": return "bg-[#548235] hover:bg-[#548235]/90"; 
      case "premium": return "bg-[#6f42c1] hover:bg-[#6f42c1]/90"; 
      case "pro": return "bg-[#0366d6] hover:bg-[#0366d6]/90"; 
      case "enterprise": return "bg-zinc-800 hover:bg-zinc-900"; 
      default: return "bg-gray-500 hover:bg-gray-600";
    }
  };
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {/* Suspend/Unsuspend Conditional Logic */}
